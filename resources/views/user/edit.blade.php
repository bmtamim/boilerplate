                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" rows="2"
                                              class="form-control @error('phone') is-invalid @enderror">{{ old('address') ?? $user->address ?? '' }}</textarea>
                                    @error('address')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" id="image"
                                           @if($user->image) data-default-file="{{ asset('storage/upload/'.$user->image) }}" @endif>
                                    @error('image')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
