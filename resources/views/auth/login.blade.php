...
<head>
    ...
    <title>Login - {{ get_setting('site_name') }}</title>
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <h1 class="">Log In to <a href="index.html"><span class="brand-name">Stockify</span></a></h1>
                    ...
                    <form class="text-left" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="form">
                            ...
                            <div class="field-wrapper">
                                {{--                                <a href="{{ route('password.reset') }}" class="forgot-pass-link">Forgot Password?</a>--}}
                            </div>

                        </div>
                    </form>
                    <p class="terms-conditions">Copyright © 2022 <a target="_blank" href="https://tamimikbal.com">Tamim
                            Ikbal</a>, All
                        rights reserved.</p>
